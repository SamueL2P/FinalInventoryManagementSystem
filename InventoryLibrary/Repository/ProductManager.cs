...
namespace InventoryManagementSystem.Repository
{
    public class ProductManager
    {
        ...
        public void AddStock(int id, int quantity)
        {
            ...
            Transaction transaction = Transaction.CreateTransaction(id, "Stock Added", quantity ,(int)product.InventoryId);
        ...
        public void RemoveStock(int id, int quantity)
        {
            ...
            if (product.ProductQuantity < quantity)
                throw new InsufficientStockException("Not enough stock to remove the requested quantity.");
            
            product.ProductQuantity -= quantity;
            _context.Products.Update(product);
            Transaction transaction = Transaction.CreateTransaction(id, "Stock Removed", quantity , (int)product.InventoryId);
            _context.Transactions.Add(transaction);
            _context.SaveChanges();
        }
